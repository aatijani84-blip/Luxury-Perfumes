    ...
    return (
        <>
            ...
            <div className="xl:flex md:flex-col gap-4 py-4 xl:flex-row md:justify-between md:flex xl:items-center md:items-center sm:flex-col sm:items-center sm:justify-center w-full">
                ...
                <nav className="flex gap-4 justify-between md:justify-end items-center">
                    ...
                    className = {({isActive}) =>
                        ...
                        <div className="absolute lg:top-5/10 left-6 bg-gray-400 text-black rounded-full h-6 w-6 flex items-center justify-center sm:top-5/10 sm:left-6">0
                        </div>
                        </div>
                    </NavLink>
            ...
            <div className = 'grid lg:grid-cols-[500px_minmax(900px,1fr)] md:grid-cols-[300px_minmax(500px,900px)] sm:grid-cols-1 border-y-2 gap-x-1 min-h-152 border-b-amber-400 border-t-amber-400 sm:col-span-3' >
                ...
                <div className = 'shadow-lg rounded-lg w-full md:order-1 sm:order-2 h-full flex items-center justify-center max-w-7xl mx-auto px-4' >
